...
var status = 1 # variável binária que controla se o jogo está em andamento ou não
var vscore = 0 # variável que armazena o valor da pontuação do jogador
var x = 1.5 # variável que influencia na velocidade do background e das colunas
var y = 1.5 # variável que determina a intensidade da gravidade que atua no dragão
